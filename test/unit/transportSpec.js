...
(function () {
  ...
  describe('The transport', function () {
    ...
    describe('playback', function(){
      var notes, track, song, attack, release, instrument;

      beforeEach(function(){
        notes = [ ["0:0:0", "C4", 1.00], ["1:0:1", "C4", 0.00] ];
        instrument =  WO.InstrumentFactory( "Acoustic Piano" );
        track = new WO.Track({notes: notes, instrument: instrument});
      ...
      it("should play and stop one note", function(done){
        ...
        var track = new WO.Track({notes: notes, instrument: instrument});
      ...
      xit("should play 1 note from 2 tracks", function(done){
